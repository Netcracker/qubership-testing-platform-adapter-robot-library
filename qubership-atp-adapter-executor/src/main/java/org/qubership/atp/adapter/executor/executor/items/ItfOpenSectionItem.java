...
@Data
@AllArgsConstructor
public class ItfOpenSectionItem extends WebReportItem {
    ...
    public void message(WebReportWriterWraper webReportWriter) {
        webReportWriter.getWebReportWriter().openSection(message.getName(), message.getMessage(), null, null);
    }

    public void openSection(AtpRamWriter writer) {
        writer.openItfSection(message, table);
    }
}
