...
abstract class ContextProvider implements ContextDataStorageProvider {
    ...
    @Nonnull
    protected abstract ContextDataStorage getForSingleScopeMode();

    @Nullable
    protected abstract ContextDataStorage getForMultiScopeMode();

    @Nonnull
    protected abstract ContextDataStorage getForPrimitive();
    ...
    @Nullable
    protected ContextDataStorage findInThreadGroups(@Nonnull Class<?> targetProviderClass) {
