...
@Data
@AllArgsConstructor
public class UiMessageItem extends WebReportItem {
    ...
    public void message(WebReportWriterWraper webReportWriter) {
        webReportWriter.getWebReportWriter().message(message.getName(), level, message.getMessage(), page);
    }

    public void message(AtpRamWriter writer) {
        writer.message(message,level,page);
    }
}
